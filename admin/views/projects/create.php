...
<div class="max-w-2xl">
  ...
  <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
    <form method="POST" action="<?= APP_URL ?>/projects/create" class="space-y-5">
      ...
      <div>
        ...
        <input type="text" id="name" name="name" required maxlength="150"
               ...
               placeholder="DevLink — Marketplace de Desarrolladores">
      </div>
      ...
      <div>
        ...
        <textarea id="description" name="description" required rows="4"
                  ...
                  placeholder="Describe el proyecto, tecnologías usadas y su impacto..."></textarea>
      </div>
